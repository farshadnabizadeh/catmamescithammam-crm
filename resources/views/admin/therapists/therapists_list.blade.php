                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        @can('edit therapist')
                                        <li><a href="{{ url('/definitions/therapists/edit/'.$therapist->id) }}" class="btn btn-info edit-btn inline-popups"><i class="fa fa-pencil-square-o"></i> Güncelle</a></li>
                                        @endcan
                                        @can('delete therapist')
                                        <li><a href="{{ url('/definitions/therapists/destroy/'.$therapist->id) }}" onclick="return confirm('Are you sure?');" class="btn btn-danger edit-btn"><i class="fa fa-trash"></i> Sil</a></li>
                                        @endcan
                                    </ul>
                                </div>
                            </td>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="therapistName" name="therapistName" placeholder="Terapist Adı" required>
                            </div>
                        </div>
                    </div>
