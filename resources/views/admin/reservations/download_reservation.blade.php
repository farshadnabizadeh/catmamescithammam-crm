                                            ...
                                            <div class="col-6">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a href="{{ url('/definitions/treatmentplans/download/de/'.$reservation->id.'?lang=de') }}" class="btn btn-primary"><img class="flag-img" src="{{ asset('assets/img/flags/de.png') }}"> Deutsch</a></li>
                                                        <li><a href="{{ url('/definitions/treatmentplans/download/it/'.$reservation->id.'?lang=it') }}" class="btn btn-primary"><img class="flag-img" src="{{ asset('assets/img/flags/it.png') }}"> Italian</a></li>
                                                        <li><a href="{{ url('/definitions/treatmentplans/download/fr/'.$reservation->id.'?lang=fr') }}" class="btn btn-primary"><img class="flag-img" src="{{ asset('assets/img/flags/fr.png') }}"> French</a></li>
                                                        <li><a href="{{ url('/definitions/treatmentplans/download/es/'.$reservation->id.'?lang=es') }}" class="btn btn-primary"><img class="flag-img" src="{{ asset('assets/img/flags/es.png') }}"> Spanish</a></li>
                                                        <li><a href="{{ url('/definitions/treatmentplans/download/ru/'.$reservation->id.'?lang=ru') }}" class="btn btn-primary"><img class="flag-img" src="{{ asset('assets/img/flags/ru.png') }}"> Russian</a></li>
                                                        <li><a href="{{ url('/definitions/treatmentplans/download/pl/'.$reservation->id.'?lang=pl') }}" class="btn btn-primary"><img class="flag-img" src="{{ asset('assets/img/flags/pl.png') }}"> Polish</a></li>
                                                        <li><a href="{{ url('/definitions/treatmentplans/download/pt/'.$reservation->id.'?lang=pt') }}" class="btn btn-primary"><img class="flag-img" src="{{ asset('assets/img/flags/pt.png') }}"> Portuguese</a></li>
                                                        <li><a href="{{ url('/definitions/treatmentplans/download/ar/'.$reservation->id.'?lang=ar') }}" class="btn btn-primary"><img class="flag-img" src="{{ asset('assets/img/flags/ar.png') }}"> Arabic</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-6">
