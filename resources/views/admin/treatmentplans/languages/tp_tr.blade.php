                                ...
                                <div class="col-6">
                                    <div class="dropdown">
                                        <button class="btn btn-primary dropdown-toggle action-btn" type="button" data-toggle="dropdown">
                                            <img class="flag-img" src="{{ asset('assets/img/tr.png') }}"> Turkish <span class="caret"></span>
                                        </button>
                                    ...
                                    <div id="root">
                                        <div class="page page-1 page2 theme-1">
                                            ...
                                            <div class="form-top">
                                                <div class="elements">
                                                    <div>
                                                        <h5>Tedavi</h5> <p>  {{ $treatment_plan->recommendedTreatment->treatment_name_tr }}</p>
                                                    </div>
                                                    <div>
                                                        <h5>Kalış Süresi</h5> <p> {{ substr($treatment_plan->duration_of_stay, 0, 1) }} <span class="night-text">Gece</span> </p>
                                                    </div>
                                                    <div>
                                                        <h5>Fiyat</h5> <p> {{ $treatment_plan->price_currency }} {{ $treatment_plan->total_price }}</p>
                                                    </div>
                                                </div>
                                                <div  class="elements">
                                                    <div>
                                                        <h5>Dr. Adı</h5> <p> <b>{{ __('Ceyhun Aydogan') }}</b> </p>
                                                    </div>
                                                    <div>
                                                        <h5>Cerrah Tavsiyesi</h5>
                                                    </div>
                                                    <div>
                                                        <p>{{ $treatment_plan->recommendedTreatment->treatment_name_tr }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="bg-blue">
                                            ...
                                            <div class="row patient-info">
                                                ...
                                                <div class="col-3">
                                                    <div class="">
                                                        <div><h4>Ameliyat Geçmişi</h4></div>
                                                    </div>
                                                </div>
                                                <div class="col-9">
                                                ...
                                                <div class="col-9">
                                                    <p><b>@if($treatment_plan->is_alcohol == "yes") Evet @elseif($treatment_plan->is_alcohol == "no") Hayır @else - @endif</b></p>
                                                </div>
                                                <div class="col-3">
                                                    <div class="">
                                                        <div><h4>Sigara</h4></div>
                                                    </div>
                                                </div>
                                                <div class="col-9">
                                                    <p><b>@if($treatment_plan->is_smoke == "yes") Evet @elseif($treatment_plan->is_smoke == "no") Hayır @else - @endif</b></p>
                                                </div>
                                            </div>
                                            <div class="list-logo list-custom">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><span><img src="{{ asset('assets/img/list-icon.png') }}" style="max-width: 10px"></span><span class="ml-1" data-attr="item-2">Hastanede yapılan tüm standart ameliyat öncesi tetkikler (Ultrason, Röntgen, Kan Testleri, Dahiliye Doktoru Konsültasyonu, Anestezi Uzmanı Konsültasyonu, Endoskopi).</span></li>
                                                    ...
                                                    <li><span><img src="{{ asset('assets/img/list-icon.png') }}" style="max-width: 10px"></span><span class="ml-1" data-attr="item-4">Ameliyat sonrası bakım hizmeti olarak 1 yıllık diyetisyen takibi</span></li>
                                                    <li><span><img src="{{ asset('assets/img/list-icon.png') }}" style="max-width: 10px"></span><span class="ml-1" data-attr="item-5">Ameliyat sonrası cerrahın yazacağı ilaçlar</span></li>
                                                    ...
                                                    <li><span><img src="{{ asset('assets/img/list-icon.png') }}" style="max-width: 10px"></span><span class="ml-1" data-attr="item-7">Kaldığınız süre boyunca ihtiyaçlarınıza destek ve yardımcı olacak, dilinizi konuşan bir tıbbi tercüman (İngilizce, İspanyolca, İtalyanca, Almanca, Arapça, Lehçe, Arnavutça, Rumence)</span></li>
                                                </ul>
                                            </div>
                                            <div class="list-logo list-custom">
                                                <div class="list-title">
                                                    <h2>Fiyata Dahil Değildir</h2>
                                                </div>
                                                <ul>
                                                    <li><span><img src="{{ asset('assets/img/list-icon.png') }}" style="max-width: 10px"></span> <span class="ml-1" data-attr="item-8">Uzun süreli yatan hasta kalışları için ücretler:</span></li>
                                                    <li><span><img src="{{ asset('assets/img/list-icon.png') }}" style="max-width: 10px"></span> <span class="ml-1" data-attr="item-9">Geliş ve gidiş uçuşlarınız</span></li>
                                                    <li><span><img src="{{ asset('assets/img/list-icon.png') }}" style="max-width: 10px"></span> <span class="ml-1" data-attr="item-10">Kişisel harcamalarınız</span></li>
                                                </ul>
                                            </div>
                                            <div class="footer">
                                                <div class="contact-infos">
                                                    <h3 class="text-white">İLETİŞİM</h3>
                                                    <div class="d-flex" style="gap: 20px;">
                                                        <div> <strong>Tıbbi Danışman: </strong>  {{ $treatment_plan->salesPerson->name_surname }}</div>
                                                    ...
                                                    <div class="newBorder2">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-4 patientInfo">
                                                                <h2 class="patient-information-title">HASTA BİLGİLERİ</h2>
                                                                <br>
                                                                <p>
                                                                ...
                                                                <p>
                                                                    <span>Kronik Hastalık:</span> @foreach($treatment_plan->chronicIllnesses as $item) <b> {{ $item->chronic_illnesses }}, </b> @endforeach
                                                                </p>
                                                                <p>
                                                                    <span>Ameliyat Geçmişi:</span> @foreach($treatment_plan->surgicalHistory as $item) <b> {{ $item->surgical_history }}, </b> @endforeach
                                                                </p>
                                                                <p>
                                                                    <span>Alerjiler:</span> @foreach($treatment_plan->allergies as $item) <b> {{ $item->allergie }}, </b> @endforeach
                                                                </p>
                                                                <p>
                                                                ...
                                                                <p>
                                                                    ...
                                                                    <b>{{ $treatment_plan->recommendedTreatment->treatment_name_tr }}</b>
                                                                </p>
                                                                <br>
                                                                <br>
                                                            ...
                                                            <div class="col-8 bg-white">
                                                                <h1 class="treatment-plan-title">TEDAVİ PLANI</h1>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="text-center">
                                                                                {{ $treatment_plan->recommendedTreatment->treatment_name_tr }}
                                                                            </td>
                                                                            <td class="text-center">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col includeText">
                                                                        ...
                                                                        <p>
                                                                            <i class="fa fa-caret-right iconsFa"></i> <span data-attr="item-1">{{ $treatment_plan->recommendedTreatment->treatment_name_tr }}</span>
                                                                        </p>
                                                                        <p>
                                                                        ...
                                                                        <p>
                                                                            <i class="fa fa-caret-right iconsFa"></i>
                                                                            <span data-attr="item-4">Ameliyat sonrası bakım hizmeti olarak 1 yıllık diyetisyen takibi</span>
                                                                        </p>
                                                                        <p>
                                                                            <i class="fa fa-caret-right iconsFa"></i>
                                                                            <span data-attr="item-5">Ameliyat sonrası cerrahın yazacağı ilaçlar</span>
                                                                        </p>
                                                                        <p>
                                                                            <i class="fa fa-caret-right iconsFa"></i>
                                                                        ...
                                                                        <p>
                                                                            <i class="fa fa-caret-right iconsFa"></i>
                                                                            <span data-attr="item-7">Hotel, hastane ve havaalanı arasında VIP ulaşım</span>
                                                                        </p>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col divPrice">
                                                                        <h3 class="titlePrice">Fiyata Dahil Değildir</h3>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col includeText2">
                                                                        <p>
                                                                            <i class="fa fa-caret-right iconsFa"></i>
                                                                            <span data-attr="item-9">Uzun süreli yatan hasta kalışları için ücretler:</span>
                                                                        </p>
                                                                        {{--
                                                                        <p>
                                                                        <i class="fa fa-caret-right iconsFa"></i>
                                                                ...
                                                                <div class="row" style="margin-top: 10px;">
                                                                    <div class="col-12">
                                                                        <h3 class="titleBeforeAfter">ÖNCESİ - SONRASI</h3>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                    ...
                                                    <div class="newBorder3">
                                                        ...
                                                        <div class="row section-service-photos" style="margin-top: 30px;">
                                                            <div class="col-12" style="margin-bottom: 20px;">
                                                                <div class="subTitle">Oteliniz</div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="img-cover">
                                                            ...
                                                            <div class="col-12" style="margin-bottom: 20px; margin-top: 20px;">
                                                                <div class="subTitle">Ulaşımınız</div>
                                                            </div>
                                                            <div class="col-4">
                                                                <div class="img-cover">
