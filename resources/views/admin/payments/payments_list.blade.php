      ...
      <div class="col-md-12 table-responsive">
         ...
         <div class="card p-3 mt-3">
            <div class="card-title">
               <div class="row">
                  <div class="col-lg-6">
                     <h2>Payments Lists</h2>
                  </div>
                  <div class="col-lg-6">
                     <button data-toggle="modal" data-target="#reservationModal" class="btn btn-primary float-right"><i class="fa fa-plus" aria-hidden="true"></i> New Payment</button>
                  </div>
               </div>
            </div>
                     ...
                     <td>
                        <div class="dropdown">
                           ...
                           <ul class="dropdown-menu">
                              <li><a href="{{ url('/definitions/reservations/edit/'.$payment->id) }}" class="btn btn-info edit-btn"><i class="fa fa-pencil-square-o"></i> Edit / Show</a></li>
                              <li><a href="{{ url('/definitions/reservations/destroy/'.$payment->id) }}" onclick="return confirm('Are you sure?');" class="btn btn-danger edit-btn"><i class="fa fa-trash"></i> Delete</a></li>
                           </ul>
                        </div>
                     </td>
                     <td>{{ date('d.m.Y', strtotime($payment->created_at)) }}</td>
                     <td>{{ $payment->reservation_time }}</td>
                     <td>{{ $payment->total_customer }}</td>
                     <td>{{ $payment->service->service_name }}</td>
                     <td>{{ $payment->service_cost }} {{ $payment->service_currency }}</td>
                     <td>{{ $payment->service_commission }}</td>
                     <td>{{ $payment->therapist->therapist_name }}</td>
                  </tr>
                  @endforeach
               </table>
            </div>
