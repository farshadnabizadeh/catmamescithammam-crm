            ...
            <div class="card-title">
               <div class="row">
                  ...
                  <div class="col-md-6">
                     ...
                     <button data-toggle="modal" data-target="#exampleModal" class="btn btn-primary float-right"><i class="fa fa-plus" aria-hidden="true"></i> New Lead Source</button>
                     @endcan
                  </div>
               </div>
            </div>
                  ...
                  <td>
                     <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                           ...
                           <li><a href="{{ route('leadsource.edit', ['id' => $lead_source->id]) }}" class="btn btn-info edit-btn inline-popups"><i class="fa fa-pencil-square-o"></i> Edit / Show</a></li>
                           @endcan
                           @can('delete lead source')
                           <li><a href="{{ route('leadsource.destroy', ['id' => $lead_source->id]) }}" onclick="return confirm('Are you sure?');" class="btn btn-danger edit-btn"><i class="fa fa-trash"></i> Delete</a></li>
                           @endcan
                        </ul>
                     </div>
                  </td>
               ...
               <div class="row">
                  <div class="col-lg-6">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter Lead Source Name" required>
                     </div>
                  </div>
               </div>
